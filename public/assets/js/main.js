(function ($) {
    ...
    $(window).on('load', function () {
        ...
        let toastku = $('.toastku')
        if(toastku.length) {
            toastku.addClass('active').find('.progress').addClass('active')
            toastku.find('.close').on('click', function() {
                toastku.removeClass('active').find('.progress').removeClass('active')
            })
            setTimeout(() => toastku.removeClass('active'), 5000)
        }
